...
export default function Form() {
  ...
  */
  ...
  const handleCreateSubmit = async (e) => {
    ...
    setForm(form);
    await dispatch(action.createForm(form));
    setProduct('');
    setLoading(false);
    handleClose();
  };
  const handleEditSubmit = async (e) => {
    ...
    form.productId = product.id;
    setForm(form);
    await dispatch(action.editForm(form.id, form));
    setProduct('');
    setLoading(false);
    handleClose();
  };
  ...
  const handleDelete = async () => {
    ...
    await dispatch(action.deleteForm(id));
    setLoading(false);
    ...
    <div>
      ...
      <Card>
        <CardHeader color='success'>
          ...
          <h4 className={classes.cardTitleWhite}>Form List</h4>
        </CardHeader>
        <CardBody>
          <Table
            tableHeaderColor='info'
            columns={columns}
            tableData={customer.formList ? customer.formList : []}
      ...
      >
        ...
        <DialogTitle id='responsive-dialog-title'>
          {dialog === 'create' ? 'Create Form' : 'Edit Form'}
        </DialogTitle>
        <DialogContent>
