...
export default function Customer() {
  ...
  */
  ...
  const handleCreateSubmit = async (e) => {
    ...
    setLoading(true);
    customer.imageUrl = preview;
    setCustomer(customer);

    await dispatch(action.createCustomer(customer));
    setLoading(false);
    handleClose();
  };
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    customer.imageUrl = preview !== '' ? preview : customer.imageUrl;
    setCustomer(customer);
    await dispatch(action.editCustomer(customer.id, customer));
    setLoading(false);
    handleClose();
  };
  ...
  const fileChangedHandler = async (e) => {
    ...
    var uploadTask = storage.ref('/customers/' + file.name).put(file);
    uploadTask.on(
      'state_changed',
      (snapShot) => {
    ...
    <div>
      ...
      >
        ...
        <DialogTitle id='responsive-dialog-title'>
          {dialog === 'create' ? 'Create Customer' : 'Edit Customer'}
        </DialogTitle>
        <DialogContent>
          <form>
            <div style={{ textAlign: 'center' }}>
              ...
              <label htmlFor='icon-button-file'>
                ...
                >
                  <Avatar
                    src={preview !== '' ? preview : customer.imageUrl}
                    style={{
                      width: '200px',
                      height: '200px',
                    }}
        ...
        <DialogActions>
          ...
          <Button
            onClick={
              dialog === 'create' ? handleCreateSubmit : handleEditSubmit
            }
            color='primary'
            autoFocus
          >
      ...
      >
        ...
        <DialogTitle id='responsive-dialog-title'>Customer detail</DialogTitle>
        <DialogContent>
          <Avatar
